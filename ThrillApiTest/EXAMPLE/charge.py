...
from common.genarate_chargedata import generate_readable_string
import time
import base64
...
#    {"code":0,"time":1771904540,"message":"success","data":[{"id":1,"name":"credit_card","show_name":"Credit Card","method":"credit_card","config":{"discount":5},"condition":None,"icon_url":"https:\/\/bg21.s3.us-east-2.amazonaws.com\/star\/credit_card_icon.png","open":"1","sort":"0","created_at":"2021-04-01 00:00:00","updated_at":"2024-06-12 05:07:47"},{"id":2,"name":"paypal","show_name":"Paypal","method":"simple","config":{"discount":5},"condition":None,"icon_url":"https:\/\/bg21.s3.us-east-2.amazonaws.com\/star\/paypal_icon.png","open":"1","sort":"0","created_at":"2021-04-01 00:00:00","updated_at":"2023-09-27 05:27:55"},{"id":4,"name":"apple_pay","show_name":"Apple Pay","method":"simple","config":{"max_amount":10000},"condition":None,"icon_url":"https:\/\/bg21.s3.us-east-2.amazonaws.com\/star\/apple_pay_icon.png","open":"1","sort":"0","created_at":"2023-02-17 09:20:49","updated_at":"2023-08-04 10:26:41"}]}

param_charge_method = {"Authorization": ""}

# api/charge/create

card_number = base64.b64encode(original_data)

card_info = {"card_number": "4200000000000000", "email": "Gucy@gmail.com", "cvc": "555", "year": "2027", "month": "04",
             "first_name": "Ggg", "last_name": "Hhh"}

card_number = base64.b64encode(card_info["card_number"])
timestamp=str(int(time.time()))
session_id=str(login_data['data']['user_id'])+str(timestamp)


param_charge_create  ={
    "bundle_id": common_data['bundle_id'],
    "card_number": card_number,
    "carrier_name": common_data['carrier_name'],
    "charge_id": "201",
    "client_version": common_data['client_version'],
    "country_code": common_data['country_code'],
    "name": "credit_card",
    "session_id": session_id,
    "system_language": "zh-Hans-CN",
    "time_zone": "Asia/Shanghai",
    "timestamp": timestamp,
    "udid": common_data['udid'],
...
app_data = {"user_id": login_data['data']['user_id'], "desc": "Deposit for "+str(resp_charge_create['data']['amount']), "app_name": common_data["bundle_id"],
            "support_wait_form": 1}

nonce=generate_readable_string()
...
extra_params = {
        ...
        "charge_id": "solitairethrill_"+str(resp_charge_create['data']['amount']),
        "account_id": "solitairethrill_" + str(login_data['data']['user_id']),
        "character_name": login_data['data']['user_info']['nick_name'],
        "player_level": login_data['data']['user_xp']['level'],
        "game_name": "solitairethrill",
        "game_item_amount": resp_charge_create['data']['amount'],
        "mobile_uid": "D3080F16-F03D-4285-90D9-081615E5D39B",
        "bundle_name": common_data["bundle_id"],
        "client_ips": resp_charge_create['data']['riskCnt']['last_login_ip'],
        "language": common_data["system_language"],
        "province": resp_charge_create['data']['riskCnt']['province'],
        "region": resp_charge_create['data']['riskCnt']['region'],
        "city": resp_charge_create['data']['riskCnt']['city'],
        "zip": resp_charge_create['data']['riskCnt']['zip'],
        "register_time": resp_charge_create['data']['riskCnt']['register_time'],
        "past_orders_count": resp_charge_create['data']['riskCnt']['past_orders_count'],
        "past_orders_amount": resp_charge_create['data']['riskCnt']['past_orders_amount'],
        "last_login_ip": resp_charge_create['data']['riskCnt']['last_login_ip'],
        "register_ip": resp_charge_create['data']['riskCnt']['register_ip'],
        }
...
# card_info = {"card_number": "4200000000000000", "email": "Gucy@gmail.com", "cvc": "555", "year": "2027", "month": "04",
#              "first_name": "Ggg", "last_name": "Hhh"}
billing_address = {"first_name": card_info['first_name'], "last_name": card_info['last_name'], "email": card_info['email']}

param_card_payment = {
    "app_order_id": resp_charge_create['data']['app_order_id'],
    "callback_url": resp_charge_create['data']['callback_url'],
    "currency": "USD",
    "country": "US",
    "state": "",
    ...
    "amount": resp_charge_create['data']['amount'],
    "nonce": nonce,
    "timestamp": timestamp,
